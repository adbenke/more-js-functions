...
function addTheValues(param1, param2){
    if(isNaN(param1) || isNaN(param2)){
        ...
        addToPage("Both values are numbers. When added together they equal: " + (parseInt(param1) + parseInt(param2)));
    }
}
...
function scopeExample(){
    let localVariable = "This is a local variable inside the scopeExample function."
